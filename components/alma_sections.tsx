...
export default function AlmaFase2Sections({
  isDark = false,
}: AlmaSectionsProps) {
  const t: ThemeTokens = {
    // Fondos
...
function HowItWorks({ t }: { t: ThemeTokens }) {
  ...
  return (
    ...
    >
      ...
      >
        Sin registros complicados. Sin curvas de aprendizaje. Solo abre,
        escribe, y deja que Alma haga el resto.
      </p>
        ...
        >
          <div
            style={{
              ...
              right: "12px",
              background: t.roseM,
              border: "1px solid rgba(196,164,154,0.3)",
              borderRadius: "20px",
              padding: "3px 9px",
              fontSize: "10px",
              color: t.rose,
              ...
              >
                {[30, 60, 45, 100, 80, 70, 90].map((h, i) => (
                  <div
                    ...
                    style={{
                      flex: 1,
                      background: i === 3 ? t.sageM : "rgba(138,158,140,0.5)",
                      height: `${h}%`,
                      borderRadius: "2px",
                    }}
                  />
        ...
        >
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              >
                Cada semana, un resumen emocional construido solo desde tus
                palabras.
              </p>
            </div>
            <UploadHint t={t}> screenshot de insights</UploadHint>
          </div>
          <div style={{ padding: "16px 24px", display: "flex", gap: "12px" }}>
            ...
            >
              ...
              >
                Detectamos un patrón de{" "}
                <strong style={{ color: t.text }}>mayor calma</strong> en tus
                entradas del mediodía.
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                Mencionas conexión y pertenencia con más frecuencia que la
                semana pasada.
              </p>
            </div>
          </div>
...
function PrivacyDeep({ t }: { t: ThemeTokens }) {
  const techRows = [
    {
      key: "Almacenamiento de entradas",
      val: "SQLite cifrado en dispositivo",
      badge: false,
    },
    {
      key: "Cifrado en reposo",
      val: "AES-256-GCM",
      badge: true,
      badgeColor: t.sage,
      badgeBg: t.sageM,
      badgeBorder: "rgba(138,158,140,0.3)",
    },
    {
      key: "Claves de cifrado",
      val: "Secure Enclave / StrongBox",
      badge: false,
    },
    { key: "Modelo de IA", val: "On-device · sin API externa", badge: false },
    {
      key: "Analíticas de telemetría",
      val: "Desactivadas",
      badge: true,
      badgeColor: "#b34a4a",
      badgeBg: "#fce8e8",
      badgeBorder: "rgba(179,74,74,0.2)",
    },
    {
      key: "Backup opcional",
      val: "iCloud cifrado / Google Drive E2E",
      badge: false,
    },
    {
      key: "Acceso de Alma a tus datos",
      val: "Imposible por diseño",
      badge: true,
      badgeColor: "#b34a4a",
      badgeBg: "#fce8e8",
      badgeBorder: "rgba(179,74,74,0.2)",
  ...
  return (
    ...
    >
      ...
      >
        Construimos Alma desde el principio con una premisa: si los datos no
        salen del dispositivo, nadie puede venderlos, hackearlos ni filtrarlos.
      ...
      >
        ...
        <motion.div variants={item} style={cardStyle}>
          ...
          >
            El modelo de análisis emocional vive completamente dentro de tu
            teléfono. No hay llamadas a ningún servidor externo cuando escribes.
          </p>
          <ul
            style={{
              listStyle: "none",
